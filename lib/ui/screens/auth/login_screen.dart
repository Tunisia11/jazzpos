...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  Future<void> _loadUsers() async {
    ...
    final users = await (db.select(db.users)..where((tbl) => tbl.isActive.equals(true))).get();
  ...
  void _navigateToSetup() async {
    await Navigator.of(context).push(
      MaterialPageRoute(builder: (ctx) => const SetupWizardScreen()),
    );
    _loadUsers();
  }
      ...
      return Scaffold(
        ...
        body: Center(
          child: Column(
            ...
            children: [
              const Icon(Icons.storefront, size: 80, color: AppTheme.primaryLight),
              ...
              ElevatedButton.icon(
                ...
                label: const Text('Lancer la configuration', style: TextStyle(color: Colors.white, fontSize: 16)),
              ),
            ],
          ),
        ),
                ...
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return InkWell(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: isSelected ? AppTheme.primary.withValues(alpha: 0.15) : const Color(0xFF161F2E),
                                    borderRadius: BorderRadius.circular(8),
                                    border: Border.all(
                                  ...
                                  child: Row(
                                    children: [
                                      CircleAvatar(
                                        radius: 18,
                                        backgroundColor: isSelected ? AppTheme.primary : Colors.grey.shade700,
                                        child: Text(
                        ...
                        OutlinedButton.icon(
                          ...
                          label: const Text('Assistant d\'installation / Ajout', style: TextStyle(fontSize: 12)),
                        ),
                      ],
                    ),
                  ),
                  ...
                  Expanded(
                    ...
                    child: Column(
                      children: [
                        Text(
                          _selectedUser != null ? 'Code PIN de ${_selectedUser!.displayName}' : 'Saisir Code PIN',
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton.icon(
                            ...
                            label: const Text('CONNEXION', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
                          ),
                        ),
                      ],
                    ),
